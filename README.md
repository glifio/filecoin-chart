...
| lotusStsLabels                     | A dictionary of the statefulset labels. Can be used as a service selector to provide a universal endpoint to the pods.                                                                                                            | `app: lotus-node-app`<br/>`availability: public`<br/>`network: mainnet`<br/>`release: stable`                                   |
